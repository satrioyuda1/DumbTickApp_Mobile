...
import { Image, TouchableOpacity, StyleSheet, FlatList, ScrollView } from 'react-native';
import {
	Container,
	Header,
	Content,
...
export default class CategoryDetail extends Component {
	...
	componentDidMount() {
		...
		Axios.get(`http://192.168.1.36:5000/api/v1/category/${params.categoryId}/events`).then((res) => {
